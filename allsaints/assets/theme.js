(function ($) {
        ...
        goDown: function () {
            ...
            if ($goDown.length > 0) {
                $goDown.on('click', function (event) {
                    event.preventDefault();
                    $('html, body').animate({
                        scrollTop: $('#product-home').offset().top
                    }, 1000, function () {});
                });
            }
        },
    ...
    APP.shopVariations = {
        init: function () {
            ...
            $('.shop-swatch').each(function() {
                var $this =  $(this);
                $('.swatches-item' ,this).on('click', function (e) {
                    e.preventDefault();
                    var $this1 = $(this);
                    if ($this1.hasClass('selected')) {
                        return false;
                    }
                    $this1.parent().siblings().removeClass('selected');
                    $this1.parent().addClass('selected');
                    $('.swatches-select',$this).val($this1.attr('data-var'));
                    $('label .var',  $this).html($this1.attr('data-var'));
                    console.log($('.swatches-select',$this).val())
                });
            })
