...
"use strict";
  ...
  $('.testimonial__nav').slick({
	...
	$('.modal-booking input[type="checkbox"]').change(function(){
		...
		$(this).each(function(){ IDs.push(this.id); });
		// console.log(IDs);
		// console.log(b);
		// console.log(c);
		...
		if ($(this).prop('checked')) {
			if (b == IDs) {
				$('.box-fill[data-id="'+c+'"]').addClass('show');
				
				$('.box-fill[data-id="'+c+'"]').css('order', order);
			}	
			...
			if (b == IDs) {
				$('.box-fill[data-id="'+c+'"]').removeClass('show');
			}
		}
	})
	// $('.modal-booking .box-seat .seat-choose').on('click', function() {
	// 	var index = $('.seat-choose').index(this);
	// 	console.log(index)
	// })
