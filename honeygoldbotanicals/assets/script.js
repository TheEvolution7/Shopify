(function($) {
	...
	function handlePreloader() {
		if($('.loader-wrap').length){
			$('.loader-wrap').delay(2100).fadeOut(500);
		}
	}
   ...
   ========================================================================== */
	...
	$(document).ready(function(){
			...
			$("#forgotPassword").click(function(){
				$("#Sign-Inn").fadeOut(100);
				setTimeout(() => {
					$("#Forgot-pass").fadeIn(500);
				}, 100);
  ...
  function moveCursor(e) {
	  ...
	  TweenLite.to(cursor_follow, 0.2, {
		  x: e.clientX - (cursor_follow.width()) / 2 - 2,
		  y: e.clientY - (cursor_follow.width()) / 2 - 2,
		  ease: 'none'
	  })
  }
  ...
  function setCursor() {
	  if (isDesktop()) {
		  ...
		  cursor_follow.removeClass('--hide');
	  } else {
		  cursor.addClass('--hide');
		  cursor_follow.addClass('--hide');
	  }
  }

  function resetCursor() {
	  cursor_follow.removeClass('--hover');
  }

  $('.link-hv,a').hover(function () {
	  cursor_follow.addClass('--hover');
  }, function () {
	  cursor_follow.removeClass('--hover');
  })
