...
//             new WOW().init();
          wow.init();
            ...
            nextArrow: '<a class="slick-prev"><svg xmlns="http://www.w3.org/2000/svg" width="41.238" height="9.586" viewBox="0 0 41.238 9.586"><path d="M224.26,274.672h39.665l-12.272-8.678" transform="translate(-224.26 -265.586)" fill="none" stroke="#fff" stroke-width="1"/></svg></a>',
            prevArrow: '<a class="slick-next"><svg xmlns="http://www.w3.org/2000/svg" width="41.239" height="9.586"><path data-name="Path 13896" d="M41.239.5H1.573l12.272 8.678" fill="none" stroke="#fff"/></svg></a>',
            responsive: [
              {
                breakpoint: 1024,
                settings: {
...
//                     $(this).text(Math.ceil(now));
                  $(this).text(Math.fround(now.toFixed(1)).toLocaleString());
                }
            });
            });
        }
...
//        e.preventDefault();
       ...
       $("#old-price-box").html(oldprice);
      	$("#new-price-box").html(newprice);
       $('.slider-nav-pro').slick('slickGoTo', slideno - 1);
     });
